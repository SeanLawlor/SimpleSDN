//source: https://github.com/hwchiu/MultipathRouting
...
import net.floodlightcontroller.multipathrouting.types.*;
...
public class MultiPathRouting implements IFloodlightModule ,ITopologyListener, IMultiPathRoutingService{
    ...
    public void generateMultiPath(MultiRoute routes, DatapathId srcDpid, DatapathId dstDpid, DatapathId dstDpid2, HashMap<DatapathId, HashSet<LinkWithCost>> previous,LinkedList<NodePortTuple> switchPorts){   
        ...
        HashSet<LinkWithCost> links = previous.get(dstDpid2);
